...
document.querySelector('.custom-horizontal-scroll-wrapper').addEventListener('wheel', (event) => {
    if (event.deltaY !== 0) {
        event.preventDefault();
        document.querySelector('.custom-horizontal-scroll-wrapper').scrollLeft += event.deltaY;
    }
});
